...
namespace UnitTests.StreamingTests
{
    class DeactivationTestRunner
    {
        ...
        public async Task DeactivationTest(Guid streamGuid, string streamNamespace)
        {
            ...
            await producer.BecomeProducer(streamGuid, streamNamespace, streamProviderName).WithTimeout(Timeout, "BecomeProducer stuck due to deactivation deadlock");
            await producer.Produce().WithTimeout(Timeout, "Produce stuck due to deactivation deadlock");
